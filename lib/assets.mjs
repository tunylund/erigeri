...
function interpolate(srcImg, tilew, tileh) {
  ...
  function blurPass(loop, iData, adjacentColorFn) {
    loop(i => {
  ...
  mn2mx(srcImg.width, tilew)(x => {
    ...
    blurPass(mn2mx(iData.length, 4), iData, nextColor)
    blurPass(mn2mx(iData.length, 4), iData, nextColor)
    blurPass(mx2mn(iData.length, 4), iData, prevColor)
    blurPass(mx2mn(iData.length, 4), iData, prevColor)
    blurPass(dw2up(tilew, tileh, 4), iData, prevRowColor)
    blurPass(dw2up(tilew, tileh, 4), iData, prevRowColor)
    blurPass(up2dw(tilew, tileh, 4), iData, nextRowColor)
    blurPass(up2dw(tilew, tileh, 4), iData, nextRowColor)
