import Q from './Q.mjs'
import buildAssets from './assetBuilder.mjs'
import { preloadAssets, loadMusic } from './assets.mjs'
...
preloadAssets((ix, expected) => {
  document.getElementById('loader').innerText = `loading... ${ix}/${expected}`
})
  .then(buildAssets)
  .then(() => {
    Q.stageScene('bg', 0)
