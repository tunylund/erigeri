...
const comboFromSensogeri = comboFrom('sensogeri', 13, 16)
const comboFromSentainoTsuki = comboFrom('sentainotsuki', 10, 16)
const comboFromFujogeri = comboFrom('fujogeri', 10, 16)
const comboFromManjigeri = comboFrom('manjigeri', 10, 13)
const comboFromSenten = comboFrom('senten', 5, 13)
const comboFromKoten = comboFrom('koten', 5, 13, function () {
...
class GeriMon extends Q.MovingSprite {
  ...
  fujogeriForward (target) {
    comboFromSentainoTsuki(jump(attack(() => {
      this.sheet("fujogeri")
  ...
  fujogeri (target) {
    comboFromSentainoTsuki(comboFromSenten(jump(attack(() => {
      this.sheet("fujogeri")
      this.play('fujogeri', 1)
      this.on('step', this, 'fujogeriStep')
    })), 4), 5).call(this, target)
  }
  ...
  hangetsuate (target) {
    comboFromManjigeri(comboFromKoten(comboFromSenten(attack(() => {
      this.sheet("hangetsuate")
      this.play('hangetsuate', 1)
    }), 5), 5), 5).call(this, target)
  }

  sentainotsuki (target) {
    comboFromSensogeri(comboFromManjigeri(attack(() => {
      this.sheet("sentainotsuki")
      this.play('sentainotsuki', 1)
    }), 7), 4).call(this, target)
  }
  ...
  manjigeri (target) {
    comboFromFujogeri(comboFromKoten(comboFromSenten(attack(() => {
      this.sheet("manjigeri")
      this.play('manjigeri', 1)
    }), 4), 4), 2).call(this, target)
  }

  suiheigeri (target) {
    comboFromSensogeri(attack(function() {
